...
CREATE TABLE IF NOT EXISTS `video` (
  ...
  `video_estat` TINYINT NULL COMMENT "1: públic  2: ocult  3: privat",
  `video_hora_publ` DATETIME NULL,
  `usuari_Usuari_id` INT NOT NULL,
  PRIMARY KEY (`video_id`),
  INDEX `fk_video_usuari1_idx` (`usuari_Usuari_id` ASC) VISIBLE,
  INDEX `fk_video_estat_video1_idx` (`video_estat` ASC) VISIBLE,
  FOREIGN KEY (`usuari_Usuari_id`)
    REFERENCES `usuari` (`Usuari_id`),
  FOREIGN KEY (`video_estat`)
...
CREATE TABLE IF NOT EXISTS `etiqueta` (
  ...
  PRIMARY KEY (`etiqueta_id`, `etiqueta_nom`),
  INDEX `fk_etiqueta_video1_idx` (`video_video_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `canal_usuario` (
  ...
  `usuari_Usuari_id` INT NOT NULL,
  PRIMARY KEY (`canal_canal_id`, `usuari_Usuari_id`),
  INDEX `fk_canal_usuario_usuari1_idx` (`usuari_Usuari_id` ASC) INVISIBLE,
...
CREATE TABLE IF NOT EXISTS `video_like` (
  `video_video_id` INT NOT NULL,
  `usuari_Usuari_id` INT NOT NULL,
  `video_like_tipus` TINYINT NOT NULL COMMENT '0: dislike, 1:like',
...
-- Carga `video`
-- ----------------------------------------------------- 
INSERT INTO `video` VALUES ('1', 'Gatitos en acción', 'Muchos gatitos haciendo cosas de gatos', '3', 'gatos.mp4', '3021', NULL,'2', '1', '0', '2', '2020-12-23 00:00:07', '1');
INSERT INTO `video` VALUES ('2', 'Perritos en acción', 'Muchos perritos haciendo cosas de perros', '37', 'perros.mp4', '4444', NULL,'37', '1', '1', '1', '2021-01-23 12:00:07', '1');
...
INSERT INTO `etiqueta` VALUES ('2', '#gatos', '1');
